...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _login() {
    ...
    if (_loginType == LoginType.moderator) {
      if (_adminEmailController.text == 'admin@example.com' &&
        ...
        setState(() {
          _errorMessage = 'Invalid moderator credentials';
        });
      }
    } else {
                    ...
                    children: [
                      ...
                      ToggleButtons(
                        isSelected: [
                          ...
                          _loginType == LoginType.moderator,
                        ],
                        onPressed: (index) {
                          setState(() {
                        ...
                        children: const [Text('User'), Text('Moderator')],
                      ),
                      const SizedBox(height: 24),
