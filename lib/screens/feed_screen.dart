...
class _FeedScreenState extends State<FeedScreen>
            ...
            onPressed: () {
              if (selectedReason != null) {
                ...
                final feedback = feedback_model.Feedback(
                  ...
                  userId: 'currentUser@example.com', // Replace with actual user
  ...
  List<Post> get filteredPosts {
    final visiblePosts = widget.posts.where((p) => p.moderationStatus != ModerationStatus.rejected).toList();
  ...
  Widget build(BuildContext context) {
    ...
    int discussionsCount =
        visiblePosts.where((p) => p.category == PostCategory.discussion).length;
    int questionsCount =
        visiblePosts
            .where((p) => p.category == PostCategory.live)
