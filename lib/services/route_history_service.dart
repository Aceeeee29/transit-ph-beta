...
class RouteHistoryService {
  ...
  void addState(List<LatLng> pathPoints, List<route_model.Step> steps, List<int> stepBoundaries) {
    ...
    final stepsCopy = List<route_model.Step>.from(steps.map((step) => 
      route_model.Step(
        mode: step.mode,
    ...
    _history.add(RouteHistoryState(
